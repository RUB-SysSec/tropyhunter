...
from lib.emulation.random import create_candidate_data


def test_regression_candidate_emulation():
    """
    Tests the emulation of a function candidate and if an output destination was found for the random data.
    """

    print("Testing candidate emulation.")
    ...
    if failed_tests:
        print("Overall failed tests for candidate emulation.")
